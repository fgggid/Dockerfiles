...
class CLI_basic(object):
    ...
    # my customized port
    IntrospectPortMap["contrail-control"] = 9083
    IntrospectPortMap["contrail-query-engine"] = 7091
    IntrospectPortMap["contrail-api"] = 9084
    IntrospectPortMap["contrail-api:0"] = 9084
    IntrospectPortMap["contrail-svc-monitor"] = 9088
